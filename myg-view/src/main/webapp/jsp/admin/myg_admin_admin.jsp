					...
					<div class="blank-page">
						<div class="panel panel-widget">
							<div class="ivu-row" style="margin-left: -8px;margin-right: -8px;">
								...
								<div class="panel panel-widget" style="width:70%;float: left;">
									<a class="hvr-icon-float-away" href="myg_admin_input.jsp">新增</a>
									<a class="hvr-icon-spin" href="myg_admin_update.jsp">修改</a>
									<a class="hvr-icon-sink-away" href="#">删除</a>
									<a class="hvr-icon-float" href="#">启用</a>
									<a class="hvr-icon-sink" href="#">禁用</a>
									<a class="hvr-icon-rotate" href="myg_admin_address.jsp">收货地址</a>
								</div>
							</div>
							<br />
							<br />

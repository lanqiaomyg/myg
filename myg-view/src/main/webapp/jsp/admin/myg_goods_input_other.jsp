								...
								<div class="form-grid1">
									<div class="bottom-form">
										...
										<div class="col-md-9 grid-form1">
											<div class="radio-inline"><label><input type="radio" name="status"> 是</label></div>
											<div class="radio-inline"><label><input type="radio" name="status"> 否</label></div>
										</div>
										<div class="clearfix"></div>
									</div>
									<div class="bottom-form">
									...
									<div class="bottom-form">
										...
										<div class="col-md-9 grid-form1">
											<input type="text" placeholder="推广描述">
										</div>
										<div class="clearfix"></div>
									</div>
									<div class="bottom-form">
									...
									<div class="bottom-form">
										...
										<div class="col-md-9 grid-form1">
											<input type="text" placeholder="简明介绍">
										</div>
										<div class="clearfix"></div>
									</div>
									<div class="bottom-form">

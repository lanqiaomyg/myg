			...
			<div id="page-wrapper">
				<form class="form-horizontal" role="form">
					<div class="form-group" style="border-bottom: 1px solid #6F6F6F; padding-bottom: 14px;">
						<label for="firstname" class="col-sm-2 control-label" style="font-size: 18px;">修改</label>
					</div>
					<div class="form-group" style=" margin-top: 40px">
						<label for="firstname" class="col-sm-2 control-label">id</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="lastname1" placeholder="商品id">
						</div>
					</div>
					<div class="form-group" style=" margin-top: 40px">
						<label for="firstname" class="col-sm-2 control-label">分类名称</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="lastname1" placeholder="商品分类名称">
						</div>
					</div>
					<div class="form-group" style=" margin-top: 40px">
						<label for="firstname" class="col-sm-2 control-label">商品描述</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="lastname1" placeholder="商品描述">
						</div>
					</div>
					<div class="form-group" style=" margin-top: 40px">
						<label for="firstname" class="col-sm-2 control-label">商品展示</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="lastname1" placeholder="商品展示">
						</div>
					</div>
					<div class="form-group" style="margin-top: 40px;">
					...
					<div class="form-group" style=" margin-top: 40px">
						<label for="disabledSelect" class="col-sm-2 control-label">商品级别 </label>
						<label class="checkbox-inline">
		      			<input type="radio" name="optionsRadiosinline" id="optionsRadios1" value="option1" checked>L1</label>
						<label class="checkbox-inline">
		      			<input type="radio" name="optionsRadiosinline" id="optionsRadios2" value="option2">L2</label>
					</div>
					<div class="form-group" style="margin-top: 40px;">
						<div class="col-sm-offset-2 col-sm-10">
							<button type="submit" class="btn btn-primary">提交</button>
							<button type="submit" class="btn btn-warning"><a href="goods_type.jsp" style="color: white;">返回</a></button>
						</div>
					</div>
					<div class="form-group" style=" margin-top: 40px">
						<label for="firstname" class="col-sm-2 control-label">banner图片</label>
						<label class="sr-only" for="inputfile">文件输入</label>
						<input type="file" id="inputfile" style="padding-left: 16px;">
					</div>
					<div class="form-group" style=" margin-top: 40px">
						<label for="firstname" class="col-sm-2 control-label">icon链接</label>
						<label class="sr-only" for="inputfile">文件输入</label>
						<input type="file" id="inputfile" style="padding-left: 16px;">
					</div>
				</form>

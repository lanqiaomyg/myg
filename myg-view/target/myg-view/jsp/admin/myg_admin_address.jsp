					...
					<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right dev-page-sidebar mCustomScrollbar _mCS_1 mCS-autoHide mCS_no_scrollbar" id="cbp-spmenu-s1">
						<div class="scrollbar scrollbar1">
							<ul class="nav" id="side-menu">
								<li>
									<a href="index.html"><i class="fa fa-home nav_icon"></i>主页</a>
								</li>
								<li class="active">
									<a href="#" class="active"><i class="fa fa-cogs nav_icon"></i> 用户管理<span class="fa arrow"></span></a>
					...
					<div class="blank-page">
						<div class="panel panel-widget">
							<div class="ivu-row" style="margin-left: -8px;margin-right: -8px;">
								<div class="search-group" style="width:60%;float:right;">
									<div class="ivu-col ivu-col-span-4" style="padding-left: 8px; padding-right: 8px;">
										<div class="ivu-input-wrapper ivu-input-type">
											<i class="ivu-icon ivu-icon-load-c ivu-load-loop ivu-input-icon ivu-input-icon-validate"></i>
											<input type="text" placeholder="联系人" class="ivu-input">
											<input type="text" placeholder="联系电话" class="ivu-input">
											<button class="btn btn-sm btn-primary">
												<i class="fa fa-angle-right"></i>查询</button>
										</div>
									</div>
								</div>
								<div class="buttons-group" style="width:30%;float: left;">
									<a class="hvr-icon-sink-away" href="#">删除</a>
									<a class="hvr-icon-bob" href="myg_admin_admin.jsp">返回</a>
								</div>
							</div>
							<br />
							<br />

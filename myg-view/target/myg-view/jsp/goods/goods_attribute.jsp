			...
			<div id="page-wrapper" style="width: auto">
				<form class="form1">
					<div style="margin-bottom: 20px;position: relative;">
						...
						<button class="btn btn-primary" style="position: absolute; right: 0px;"><a href="goods_add.jsp" style="color: white;">新增</a></button>
						<button class="btn btn-warning" style="position: absolute; right: 64px;"><a href="goods_update.jsp" style="color: white;">修改</a></button>
								...
								<table class="table table-hover">
									<thead>
										<tr>
											...
											<th style="width: 810px;">名称</th>
											<th style="width: 810px;">是否可用</th>
										</tr>
									</thead>
									<tbody>
										<tr>
											...
											<td>Nash</td>
											<td>
												<span id="qiyong" style="background-color: #337AB7;display: none;">启用</span>
												<span id="jinzhi" style="background-color: crimson;">禁止</span>
											</td>
										</tr>
										<tr>
											<td>1</td>

			...
			<div id="page-wrapper">
				<form class="form-horizontal" role="form">
					...
					<div class="form-group" style=" margin-top: 40px">
						<label for="firstname" class="col-sm-2 control-label">商品</label>
						<div class="col-sm-10">
					...
					<div class="form-group" style=" margin-top: 40px">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="lastname1" placeholder="商品规格">
						</div>
					</div>
					<div class="form-group" style=" margin-top: 40px">
						<label for="firstname" class="col-sm-2 control-label">规格描述</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="lastname1" placeholder="规格描述">
						</div>
					</div>
					<div class="form-group" style="margin-top: 40px;">
						<div class="col-sm-offset-2 col-sm-10">
							<button type="submit" class="btn btn-primary">提交</button>
							<button type="submit" class="btn btn-warning"><a href="goods_size.jsp" style="color: white;">返回</a></button>
						</div>
					</div>
				</form>

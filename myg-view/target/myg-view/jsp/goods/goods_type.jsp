			...
			<div id="page-wrapper">
				<form class="form1">
					<div style="margin-bottom: 20px;position: relative;">
						<button class="btn btn-default" style="margin-left: 20px;">刷新</button>
						<button class="btn btn-primary" style="position: absolute;right: 0px;"><a href="goods_type_add.jsp" style="color: white;">新增</a></button>
						<button class="btn btn-warning" style="position: absolute; right: 64px;"><a href="goods_type_update.jsp" style="color: white;">修改</a></button>
						...
						<div class="bottom-table" style="width: auto">
							<div class="bs-docs-example" style="height: 343px; overflow-y: scroll;border: 1px solid #6F6F6F;">
								<table class="table table-hover">
									<thead>
										<tr>
											<th style="width: 126px;"><input type="checkbox" class="onliycheck" /></th>
											<th style="width: 175px;">id</th>
											<th style="width: 350px;">分类名称</th>
											<th style="width: 525px;">描述</th>
											<th style="width: 175px;">首页展示</th>
											<th style="width: 175px;">显示</th>
											<th style="width: 174px;">级别</th>
										</tr>
									</thead>
									<tbody>
										<tr>
											...
											<td>Nash</td>
											<td>
												<i class="glyphicon glyphicon-download" aria-hidden="true" style="display: inline; margin-right: 20px;"></i>志趣
											</td>
											<td>Nash</td>
											<td>
												<span id="qiyong" style="background-color: #337AB7;display: none;">是</span>
												<span id="jinzhi" style="background-color: crimson;">否</span>
											</td>
											<td>Nash</td>
										</tr>
										<tr>

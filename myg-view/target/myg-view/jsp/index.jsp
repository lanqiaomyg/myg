            ...
            <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right dev-page-sidebar mCustomScrollbar _mCS_1 mCS-autoHide mCS_no_scrollbar" id="cbp-spmenu-s1">
                <div class="scrollbar scrollbar1">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="index.jsp" class="active"><i class="fa fa-home nav_icon"></i>主页</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-cogs nav_icon"></i> 用户管理<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
                                <li>
                                    <a href="admin/myg_admin_admin.jsp">用户管理</a>
                                </li>
                            </ul>
                            <!-- /nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level collapse">
                                <li>
                                    <a href="goods/goods_attribute.jsp">商品属性种类</a>
                                </li>
                                <li>
                                    <a href="goods/goods_type.jsp">商品类型</a>
                                </li>
                                <li>
                                    <a href="admin/myg_goods_allgoods.jsp">所有商品</a>
                                </li>
                                <li>
                                    <a href="goods/goods_size.jsp">商品规格</a>
                                </li>
                                <li>
                                    <a href="goods/goods_setting.jsp">产品设置</a>
                                </li>
                                <li>
                                    <a href="goods/goods_RecycleBin.jsp">商品回收站</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a><i class="fa fa-th-large nav_icon"></i>订单管理<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
                                <li>
                                    <a href="order/ Order.html">所有管理</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level collapse">
                                <li>
                                    <a href="system/sys_admin.jsp">管理员管理</a>
                                </li>
                                <li>
                                    <a href="system/sys_role.jsp">角色管理</a>
                                </li>
                                <li>
                                    <a href="system/sys-logs.jsp">系统日志</a>
                                </li>
                                <li>
    ...
    <div id="page-wrapper">
        <div class="main-page">
            ...
            <div class="play-grid">
                ...
                <script src="<%=basePath%>js/amstock.js" type="text/javascript"></script>

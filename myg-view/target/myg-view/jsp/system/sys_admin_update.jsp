						...
						<div class="col-md-6 form-grid col-lg-12">
							<div class="form-grid1">
								...
								<div class="bottom-form">
									...
									<div class="col-md-9 grid-form1">
										<input type="email" placeholder="所属部门" readonly>
								...
								<div class="bottom-form">
									...
									<div class="col-md-9 grid-form1">
										<input type="text" value="www.test@163.com">
								...
								<div class="bottom-form">
									...
									<div class="col-md-9 grid-form1">
										<input type="text" value="13838000038">
								...
								<div class="bottom-form">
									...
									<div class="col-md-9 grid-form1">
										<div class="checkbox-inline"><label><input type="checkbox" checked> 超级管理员</label></div>
								...
								<div class="bottom-form">
									...
									<div class="col-md-9 grid-form1">
										...
										<div class="radio-inline"><label><input type="radio" checked name="status"> 正常</label></div>
									</div>
									<div class="clearfix"></div>
								</div>
								<div class="bottom-form">
